...
// absolute path to tsconfig.json (adjust the relative part if needed)
...
export default tsEslint.config(
    {
        ...
        rules: {
                    ...
                    patterns: [
                        {
                            ...
                            message: "Don't use 'rxjs/operators'; use pipeable imports from 'rxjs' instead.",
                        },
                        {
                            group: ['@angular/**'],
                            importNames: ['Inject'],
            ...
            // ----------------------------------
            '@ngrx/prefix-selectors-with-select': 'off', // 'error', 'warn', 'off'
            // ********************************** ngrx-end
    ...
    {
        files: ['**/*.component.ts', '**/*.service.ts', '**/*.directive.ts', '**/*.pipe.ts', '**/*.module.ts'],
        languageOptions: {
            parserOptions: {
                ecmaVersion: 2020,
                sourceType: 'module',
    ...
    {
        files: ['**/*.spec.ts*', '**/*.cy.*', '**/*.test.*', '**/*.unit.*', '**/*/__tests__/*', '**/*.fixture.ts'],
        languageOptions: {
            parserOptions: {
                ecmaVersion: 2020,
                sourceType: 'module',
