...
import {SELECT_AUTH_SIGN_IN_RECEIVED_TIME_RESPONSE} from '../_store/auth.selector';
import * as AUTH_ACTIONS from './../_store/auth.action';
...
export class HangSignInComponent {
  ...
  public onSubmit(): void {
    ...
    this.store.dispatch(AUTH_ACTIONS.POST_SIGN_IN_AUTH({request: REQUEST}));
  }
}
